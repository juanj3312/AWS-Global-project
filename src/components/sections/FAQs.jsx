          ...
          {faqs.map((faq, index) => (
            <div
              ...
              className={`rounded-lg shadow-sm border border-gray-200 overflow-hidden transition-all duration-500 ease-in-out group ${
                openIndex === index ? 'bg-[#ff9900] shadow-lg scale-[1.02] backdrop-blur-sm' : 'bg-white hover:bg-[#ff9900]'
              }`}
            >
              <button
                onClick={() => toggleFAQ(index)}
                className={`w-full flex items-center justify-between p-4 md:p-5 text-left transition-all duration-500 ease-in-out ${
                  openIndex === index ? 'bg-[#ff9900] backdrop-blur-sm' : 'hover:bg-[#ff9900]'
                }`}
              >
              ...
              {openIndex === index && (
                <div className="px-4 md:px-5 pb-4 md:pb-5 pt-2 rounded-b-lg transition-all duration-500 ease-in-out backdrop-blur-sm bg-[#ff9900]">
                  {index === 11 ? (
